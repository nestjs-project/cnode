import { Model, Document, Types, QueryFindOneAndUpdateOptions } from 'mongoose';
...
export abstract class BaseService<T extends Document> {
     ...
     * @memberof BaseService
     */
    async update(id: any | number | string, update: Partial<T>, options: QueryFindOneAndUpdateOptions = { new: true }): Promise<T | null> {
