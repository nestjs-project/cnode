import { Model, Document, Types, QueryFindOneAndUpdateOptions , ModelPopulateOptions } from 'mongoose';
...
export abstract class BaseService<T extends Document> {
     ...
     * @memberof BaseService
     */
    async update(id: string, update: Partial<T>, options: QueryFindOneAndUpdateOptions  = { new: true }): Promise<T | null> {
